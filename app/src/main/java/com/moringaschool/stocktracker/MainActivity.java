...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] symbols = {"TSLA", "AAPL", "AMZN", "MSFT", "NIO", "NVDA", "MRNA"
                , "NKLA", "FB", "AMD", "ZOOM", "INTU", "COST", "TMUS", "PAPXX"
                , "ABNB", "AMGN", "NFLX", "PEP", "SBUX", "CMSK"};
        String[] names = {"Tesla", "Apple Inc", "Amazon", "Microsoft", "Nio Limited"
                ...
                "Amgen", "Netflix", "PepsiCo Inc", "Starbucks", "Comcast",};
